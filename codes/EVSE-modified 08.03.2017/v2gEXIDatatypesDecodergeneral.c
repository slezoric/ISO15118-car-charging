	...
	while(!done) {
		...
		case 104:
			...
			if (errn == 0) {
				switch(eventCode) {
				case 0:
					errn = decode_v2gAuthorizationReqType(stream, &v2gBodyType->AuthorizationReq, eventCode);
				...
				case 2:
					...
					break;
				case 3:
					errn = decode_v2gCableCheckReqType(stream, &v2gBodyType->CableCheckReq, eventCode);
					v2gBodyType->CableCheckReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 5:
					errn = decode_v2gCertificateInstallationReqType(stream, &v2gBodyType->CertificateInstallationReq, eventCode);
					v2gBodyType->CertificateInstallationReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 7:
					errn = decode_v2gCertificateUpdateReqType(stream, &v2gBodyType->CertificateUpdateReq, eventCode);
					v2gBodyType->CertificateUpdateReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 9:
					errn = decode_v2gChargeParameterDiscoveryReqType(stream, &v2gBodyType->ChargeParameterDiscoveryReq, eventCode);
					v2gBodyType->ChargeParameterDiscoveryReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 11:
					errn = decode_v2gChargingStatusReqType(stream, &v2gBodyType->ChargingStatusReq, eventCode);
					v2gBodyType->ChargingStatusReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 13:
					errn = decode_v2gCurrentDemandReqType(stream, &v2gBodyType->CurrentDemandReq, eventCode);
					v2gBodyType->CurrentDemandReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 15:
					errn = decode_v2gMeteringReceiptReqType(stream, &v2gBodyType->MeteringReceiptReq, eventCode);
					v2gBodyType->MeteringReceiptReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 17:
					errn = decode_v2gPaymentDetailsReqType(stream, &v2gBodyType->PaymentDetailsReq, eventCode);
					v2gBodyType->PaymentDetailsReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 19:
					errn = decode_v2gPaymentServiceSelectionReqType(stream, &v2gBodyType->PaymentServiceSelectionReq, eventCode);
					v2gBodyType->PaymentServiceSelectionReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 21:
					errn = decode_v2gPowerDeliveryReqType(stream, &v2gBodyType->PowerDeliveryReq, eventCode);
					v2gBodyType->PowerDeliveryReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 23:
					errn = decode_v2gPreChargeReqType(stream, &v2gBodyType->PreChargeReq, eventCode);
					v2gBodyType->PreChargeReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 25:
					errn = decode_v2gServiceDetailReqType(stream, &v2gBodyType->ServiceDetailReq, eventCode);
					v2gBodyType->ServiceDetailReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 27:
					errn = decode_v2gServiceDiscoveryReqType(stream, &v2gBodyType->ServiceDiscoveryReq, eventCode);
					v2gBodyType->ServiceDiscoveryReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 29:
					errn = decode_v2gSessionSetupReqType(stream, &v2gBodyType->SessionSetupReq, eventCode);
					v2gBodyType->SessionSetupReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 31:
					errn = decode_v2gSessionStopReqType(stream, &v2gBodyType->SessionStopReq, eventCode);
					v2gBodyType->SessionStopReq_isUsed = 1u;
					grammarID = 5;
					break;
				case 33:
					errn = decode_v2gWeldingDetectionReqType(stream, &v2gBodyType->WeldingDetectionReq, eventCode);
